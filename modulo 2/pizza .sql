...
VALUES ("peperone","Calabresa",30.00,"Recheada",1);

INSERT INTO tb_pizzas (nome,sabor,valor,borda,categoria_id)
VALUES ("sorvetera ","Carne seca",80.00,"Recheada",2);

INSERT INTO tb_pizzas (nome,sabor,valor,borda,categoria_id)
VALUES ("Portuguesa","Presunto e ovo toscana",31.00,"Recheada",3);

INSERT INTO tb_pizzas (nome,sabor,valor,borda,categoria_id)
VALUES ("Marzuritaa","Mussarela",32.00,"Recheada",4);

INSERT INTO tb_pizzas (nome,sabor,valor,borda,categoria_id)
VALUES ("Mussarela","Calabresa",32.00,"Recheada",5);

INSERT INTO tb_pizzas (nome,sabor,valor,borda,categoria_id)
VALUES ("Vegetariana","Legumes rohro",80.00,"Recheada",1);
